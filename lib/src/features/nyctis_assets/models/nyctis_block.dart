...
///
/// The wallet wants exactly one field from this: [time]. A Nyctis note
...
///
/// That is a fact about the Zcash chain, not a claim about Nyctis state: a
...
class NyctisBlock {
  ...
  factory NyctisBlock.fromJson(Map<String, Object?> json) {
    return NyctisBlock(
      height: nyctisInt(json, 'height'),
      hash: nyctisStringOrNull(json, 'hash') ?? '',
      time: nyctisIntOr(json, 'time', 0),
      canonical: nyctisBoolOr(json, 'canonical', false),
    );
  }
}
