...
/// Widgetbook use cases for the receipt a Nyctis activity row opens.
///
...
NyctisActivityDetailArgs _netChange() => NyctisActivityDetailArgs(
  item: NyctisActivityItem(
    msgId: _messageId,
    assetId: _namedAssetId,
...
Widget buildNyctisActivityDetailSentUseCase(BuildContext context) {
  return _stage(context, NyctisActivityDetailBody(args: _sent()));
}

Widget buildNyctisActivityDetailReceivedUseCase(BuildContext context) {
  return _stage(context, NyctisActivityDetailBody(args: _received()));
}

Widget buildNyctisActivityDetailNetChangeUseCase(BuildContext context) {
  return _stage(context, NyctisActivityDetailBody(args: _netChange()));
}

Widget buildNyctisActivityDetailNoMessageUseCase(BuildContext context) {
  return _stage(context, const NyctisActivityDetailBody(args: null));
}
