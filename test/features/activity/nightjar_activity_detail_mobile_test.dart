...
/// The mobile Nightjar message receipt: the same facts as desktop, rendered
...
import 'package:zcash_wallet/src/features/activity/screens/mobile/mobile_nightjar_activity_detail_screen.dart';
...
Future<void> _pumpScreen(
  ...
  final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (_, _) => MobileNightjarActivityDetailScreen(args: args),
      ),
    ],
  );
  ...
  router.push(nightjarActivityDetailRouteFor(_messageId), extra: args);
  await tester.pumpAndSettle();
}
...
void main() {
  ...
  testWidgets('a route reached without a message invents nothing', (
    ...
    expect(find.text(kNightjarActivityDetailTitle), findsOneWidget);
