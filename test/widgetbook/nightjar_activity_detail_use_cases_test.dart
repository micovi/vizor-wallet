...
import 'package:zcash_wallet/widgetbook/nightjar_activity_detail_use_cases.dart';
...
void main() {
  ...
  const builders = <WidgetBuilder>[
    buildNightjarActivityDetailSentUseCase,
    buildNightjarActivityDetailReceivedUseCase,
    buildNightjarActivityDetailNetChangeUseCase,
    buildNightjarActivityDetailNoMessageUseCase,
  ];

  testWidgets('every Nightjar receipt use case renders in both themes', (
    tester,
  ) async {
